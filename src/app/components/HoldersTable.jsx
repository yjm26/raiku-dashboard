...
export default function HoldersTable({ rows = [], startRank = 0, sortKey = null, sortDir = 'desc', onSort = () => {} }) {
  const displayName = (r) => r.isPda ? (r.pdaLabel || 'Pool / program') : formatAddress(r.owner);
