...
export default function App() {
  ...
  const primary = [
    { label: 'Supply', value: formatNumber(stats.supply), detail: 'rkuSOL in circulation', tone: 'blue', emphasis: true, hint: 'Total rkuSOL tokens in circulation, from on-chain token accounts. This is the token count (rkuSOL), not the staked value in SOL.', delta: hSupply?.text, deltaTone: hSupply?.tone },
