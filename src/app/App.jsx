...
export default function App() {
  ...
  const primary = [
    ...
    { label: 'Real wallets', value: formatNumber(stats.realWallets, { maximumFractionDigits: 0 }), detail: 'excl. pools and programs', hint: 'Only System-Program-owned accounts. Pools and program accounts (Sanctum, Jupiter, etc.) and closed accounts are excluded and labeled in the holder table.', change: dailyChange(history, 'realWallets'), trend: recent(history, 'realWallets') },
  ...
  const secondary = [
    ...
    { label: 'rkuSOL rate', value: rateLabel, hint: 'Exchange rate: 1 rkuSOL = this much SOL. Calculated as TVL ÷ rkuSOL supply. Above 1 means yield has accrued.' },
