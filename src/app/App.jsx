...
export default function App() {
  ...
  const primary = [
    ...
    { label: 'Real wallets', value: formatNumber(stats.realWallets, { maximumFractionDigits: 0 }), detail: 'excluding pools and PDAs', tone: 'green', hint: 'Only System-Program-owned accounts. Pools, PDAs and program accounts are excluded.' },
