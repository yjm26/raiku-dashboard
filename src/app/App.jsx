...
import LstCompare from './components/LstCompare.jsx';
...
export default function App() {
  ...
  const primary = [
    { label: 'Supply', value: formatNumber(stats.supply), detail: 'rkuSOL in circulation', tone: 'blue', emphasis: true, hint: 'Total rkuSOL token supply currently in circulation, from on-chain token accounts.' },
    { label: 'Holders', value: formatNumber(stats.totalOwners, { maximumFractionDigits: 0 }), detail: 'all token accounts', hint: 'Every owner of a rkuSOL token account, including pools and program accounts.' },
    { label: 'Real wallets', value: formatNumber(stats.realWallets, { maximumFractionDigits: 0 }), detail: 'excluding pools and PDAs', tone: 'green', hint: 'Only System-Program-owned accounts. Pools and program accounts (Sanctum, Jupiter, etc.) and closed accounts are excluded and labeled in the Type column.' },
